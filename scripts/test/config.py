...
DPO_MODEL_PATH = "tinker://your_dpo_model_id/sampler_weights/final"
...
PROMPT_PATH = "prompts.json"  # Used if PROMPT_MODE is 'json'

# System prompt settings
USE_SYSTEM_PROMPT = True
SYSTEM_PROMPT = "You are an expert assistant that answers clearly and concisely."
